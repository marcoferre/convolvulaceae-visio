...
void setup(){
  ...
  //classes_va = loadJSONArray("../data/rhubarb/classes_va.json");
  //predictions = loadJSONArray("../data/rhubarb/predictions.json");
  //song = new SoundFile(this, "../data/rhubarb/audiofile.wav");
